...
app.delete('/admin2/users/:id', async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      text: 'Dear User, Your Account has been Deleted by the Admin. It might be due to violation of any of our Terms&Conditions.\nFor queries contact us at esellbid@gmail.com\n\n Thankyou ESELL Team.',
    };
...
app.post('/product-approval/accept/:productId', async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      text: `Dear ${email},\n\nYour product ${name} has been approved by the admin. Continue using our platform.\n\nThankyou ESELL Team.\n`,
    };
...
app.post('/product-approval/send-rejection-email', async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      ...
      text: `Dear ${email},\n\nWe regret to inform you that your product has been rejected by the Admin. Thank you for using our platform.\nFor queries contact us at esellbid@gmail.com\n\nThankyou ESELL Team.`,
    };
...
app.post('/signup', async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      text: 'Dear User,\n\nThank you for creating an account with ESELL Online Bidding Platform. We are delighted to have you as a new member of our platform. This email serves as a confirmation of your successful account creation.\n\nTo access your account, please visit our website and log in using your provided credentials. Once logged in, you will be able to enjoy all the features and benefits our platform has to offer.\n\nWe hope you have a fantastic experience with our services and find great value in using our platform. Thank you for choosing ESELL.\n\nBest regards,\nESELL Team.',
    };
        ...
        .then((user) => {
          if (user) {
            ...
            const mailOptions = {
              ...
              text: 'Dear User,\nYou have been reported on our website. Please review your activities and adhere to our policies.\n\n Thankyou ESELL Team.',
            };
...
app.get('/users/:username', (req, res) => {
    ...
    // Fetch the profile data for the specified username from the database
  ...
  app.get('/products/:email', async (req, res) => {
    try {
      ...
      if (user) {
        // console.log(user)
        // Fetch the products for the user from the database
        const products = await AcceptedProduct.find({ email:email });
